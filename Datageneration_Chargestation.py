...
end  = base + datetime.timedelta(days=1095)
...
with open(filename, 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    header = ['ChargePoint','VID','type','Region','battery', 'iSoC','finalcharge ','charged amount','start time','stop time','duration','power_con','WeekDay','Year','Month','Day', 'Hour','minute']
    writer.writerow(header)
seed(1)

for j in range(100000000000000000):
